...
class OAuth2(object):
    def __init__(self):
        ...
        self._config_path = os.path.expanduser('~/.config/earthengine/refresh_token.json')
...
#    parser.add_argument('-a', '--add-missing', help='add missing features from the last inserted feature index',
