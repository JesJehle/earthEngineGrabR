...
# Change in the earthEngineGrabR Package due to the shut down of the Fusion Table API
On December 3, Google shot down the [fusion table service](https://support.google.com/fusiontables/answer/9551050?visit_id=637115143730978855-1704825216&rd=1), which is used by the earthEngineGrabR to upload vector data from R to GEE. Since, there is no free alternative service, a major change in package workflow was requried. I used issue to further simplify the package and reduced its dependecies.
...
* **Grab** data according to a user defines data reuquest from within R.
